...
import { getPaperDisplayYear } from "@/utils/lib/paper-display-year";
    ...
    >
      <div className="flex md:flex-row flex-col gap-4 p-2 w-full">
        ...
        <div className="flex flex-col flex-1 min-w-0 py-2">
          ...
          {/* date - use conference year from publisher when available (e.g. CVPR 2025) */}
          <div className="flex items-center gap-2 text-sm mb-1">
            <Image src={dateIcon} alt="date" width={16} height={16} />
            <p>{getPaperDisplayYear(publication) || publication.date}</p>
          </div>

          {/* authors - all names, no "..."; wrap to two lines if needed */}
